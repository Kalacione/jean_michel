...
-- ============================================================
-- MIGRATION 052 — paradigmes specialist alignés sur report_findings
-- Cause : 5 paradigmes mentionnaient encore return_to_user comme verbe
-- de sortie pour les specialists, en conflit avec l'orchestrateur qui
-- exige report_findings. Le LLM recevait un contrat contradictoire et
-- ne convergeait jamais.
-- ============================================================
...
-- MIGRATION 059 — enforce manage_todo_list usage (renforcement paradigmes)
UPDATE paradigms
SET
...
-- search_then_synthesize: replace text-only "5 searches max" with a reference
-- to the structural gate enforced by the orchestrator (MAX_SEARCH_CALLS_PER_REQUEST,
-- default 10). The structural gate restricts to report_findings once the budget
-- is hit, making the text limit advisory for early planning.
UPDATE paradigms SET
...
-- wikipedia_search_strategy: add structural search budget note.
UPDATE paradigms SET
